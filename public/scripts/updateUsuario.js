...
async function getExcluirContaVie() {
    const response = await fetch(front_url+"/viewExcluir");
    ...
    const negarExclusao = document.querySelector("#negarExclusao");
        ...
        confirmarExclusao.addEventListener("click", async () => {
            await fetch(base_url+"/excluir-conta", {
                method: "POST",
                credentials: "include"
            });
            loggout()
...
async function getVerificarContaVie(nextFunction) {
    ...
    const responseView = await fetch(front_url+"/viewVerificacao");
    const responseHTML = await responseView.text();

    const responseCodigo = await fetch(base_url+"/sendemail-logged");
...
async function getMudarNome(){
    const response = await fetch(front_url+"/viewMudarNome");
    const responseHTML = await response.text();
    ...
    avancar.addEventListener("click", async () => {
        ...
        await fetch(base_url+"/alterar-usuario", {
            method : "POST",
            credentials : "include",
            headers: {
...
async function getMudarSenha() {
    const response = await fetch(front_url+"/viewMudarSenha");
    const responseHTML = await response.text();
